...
break;
  ...
  return(
    <div className="col-2 text-center">
      {button}
      <br /><br />
      <button className="btn btn-warning btn-sm" onClick={props.redraw} disabled={props.redraws === 0}> <i className="fa fa-refresh"></i>
      {props.redraws}
      </button>
  </div>
);
...
selectNumber = (clickedNumber) => {
        // check if clickedNumber already exists on the selectedNumbers array
...
answerIsCorrect: null,
randomNumberOfStars: Game.randomNumber(),
}), this.updateDoneStatus); // call back function that will be executed after this set state is done
};
